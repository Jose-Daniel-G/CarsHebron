...
//AJAX
Route::get('/curso/{id}', [WebController::class, 'cargar_datos_cursos'])->name('cargar_datos_cursos')->middleware('auth','can:cargar_datos_cursos');
Route::get('/cargar_reserva_profesores/{id}', [WebController::class, 'cargar_reserva_profesores'])->name('cargar_reserva_profesores')->middleware('auth','can:cargar_reserva_profesores');
