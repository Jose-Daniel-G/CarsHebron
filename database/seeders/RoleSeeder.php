...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.asistenciass.registrar_asistencia'])->syncRoles([$superAdmin, $admin, $secretaria, $profesor]);
        Permission::create(['name' => 'admin.asistenciass.list_inacistencias'])->syncRoles([$superAdmin, $admin, $secretaria, $profesor]);
