...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.home'])->syncRoles([$admin, $secretaria, $profesor, $usuario, $cliente]);
        ...
        Permission::create(['name' => 'cargar_reserva_profesores'])->syncRoles([$admin, $usuario]);
