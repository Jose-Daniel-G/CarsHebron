    {{-- MODAL --}}
    <div class="modal fade" id="claseModal" tabindex="-1" aria-labelledby="mdalSelected" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mdalSelected">Fechas</h5>
                ...
                <div class="modal-body">
                    <form action="" autocomplete="off" id="eventoForm" method="POST">
                        ...
                        <div class="form-group d-none">
                            <label for="start1">Inicio</label>
                            <input type="date" class="form-control" name="start" id="start">
                        </div>
                        <div class="form-group d-none">
                            <label for="end1">Fin</label>
